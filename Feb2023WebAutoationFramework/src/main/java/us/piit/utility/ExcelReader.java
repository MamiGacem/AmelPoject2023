...
//            }
    ...
    public static void main(String[] args)  {
        String path = "Feb2023WebAutoationFramework/data/data.xlsx";
...
//        System.out.println(items);
        System.out.println( excelReader.getEntireColumnData("data",0,2));
//        //System.out.println( excelReader.getDataFromCell("data",1,1));
//       // System.out.println( excelReader.getEntireColumnForGivenHeader("data","states"));
//    //    System.out.println( excelReader.getValueForGivenHeaderAndKey("data","ID","101"));
    }
}

//    public static void main(String[] args)  {
//        String path = "C:\\Users\\Amel Boucetta Gacem\\eclipse-workspace\\Feb2023WebAutoationFramework\\data\\data2.xlsx";
//        ExcelReader excelReader = new ExcelReader(path);
//        System.out.println(excelReader.getValueForGivenHeaderAndKey("data","ID","101"));
////        List<String> items = excelReader.getEntireColumnForGivenHeader("Sheet1", "id");
////        //String items = excelReader.getValueForGivenHeaderAndKey("Sheet1", "id", "id004");
...
//
//        public String getDataFromCell(String sheet, int rowNum, int colNum){
//            try { // fileinput is a virtual file and load it to excel workbook
//                FileInputStream excelFile = new FileInputStream(path);
//                excelWBook = new XSSFWorkbook(excelFile);
//                excelWSheet = excelWBook.getSheet(sheet); // which sheet you use
//                cell = excelWSheet.getRow(rowNum).getCell(colNum); // cell and column to get the cross
//                String cellValue = cell.getStringCellValue(); // grub the string of the cell value
//                excelFile.close();
//                return cellValue;
//            }catch (Exception e){
//                log.info("no file found");
...
//       String path = "C:\\Users\\Amel Boucetta Gacem\\eclipse-workspace\\Feb2023WebAutoationFramework\\data\\data2.xlsx";
//        ExcelReader excelReader = new ExcelReader(path);
//       // excelReader.getDataFromCell("data",1,1);
//        System.out.println( excelReader.getEntireColumnData("data",0,2));
//        //System.out.println( excelReader.getDataFromCell("data",1,1));
//       // System.out.println( excelReader.getEntireColumnForGivenHeader("data","states"));
//    //    System.out.println( excelReader.getValueForGivenHeaderAndKey("data","ID","101"));
